...
Grafo::Result Grafo::FindPathBFS(
  ...
  stack.push(startId);
  visited.push_back({startId, startId});
...
Grafo::Result Grafo::FindPathBP(const std::vector<Node> &nodes,
...
Grafo::Result Grafo::FindPathGreedy(const std::vector<Node> &nodes,
                                    const std::vector<Connection> &connections,
                                    const std::vector<uint8_t> &nodeActive,
                                    uint32_t startId, uint32_t endId) {
  Result result;
...
Grafo::Result Grafo::FindPathAstart(const std::vector<Node> &nodes,
                                    const std::vector<Connection> &connections,
                                    const std::vector<uint8_t> &nodeActive,
                                    uint32_t startId, uint32_t endId) {
  Result result;
